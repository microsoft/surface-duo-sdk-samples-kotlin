...
import com.microsoft.device.display.samples.dualview.model.RestaurantCoordinates
...
class MapSimulator(val context: Context) {
     ...
     */
    fun generateMap(locationList: List<RestaurantCoordinates>, selectedPosition: Int?): Bitmap {
        val finalBitmap =
