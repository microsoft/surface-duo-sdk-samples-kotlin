...
class DualLandscape : BaseFragment(), OnPageChangeListener, ContextFragment.OnItemSelectedListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_dual_landscape, container, false)
    ...
    companion object {
        fun newInstance(slides: ArrayList<Slide>): DualLandscape {
            return DualLandscape().apply {
                this.slides = slides
